...
Does this work? []{label=”proglangss”}

: Another table caption []{label=”proglangss”}
...
| \begin{equation}\mathcal{P}\end{equation} | `single\_cell\_survival`          | Single CTC survival probability                                               | $  5\times 10^{-4}   $   |
