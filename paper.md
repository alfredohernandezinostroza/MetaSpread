...
The dimensionless model, as described by Franssen et al. [@Franssen2019] corresponds to 4 PDEs, where the variables...:
...
Where, once discretized, where i menas... j... n... take up the form:
...
Where the probabilities to move up, down, left, right, or staying, correspond to:
...
For this simulations there was an extra probability of going to another grid
